...
const chooses = [
    ...
    /* special offers section */
        const specialoffers = [
            { Rectangle: 'assets/Rectangle 1.png',
                rate: 'assets/rating.png', 
                favorite: 'assets/favorite.png', 
                SpecialofferDescription: 'Wilderness Club at Big <br> Ceddar', 
                months:"28 October — 1 November", 
                price:"$2016", 
                night:"/6 night"
            },
            { Rectangle: 'assets/Rectangle 2.png', 
                rate: 'assets/rating.png', 
                favorite: 'assets/favorite.png', 
                SpecialofferDescription: "Wilderness Club at Big <br> Ceddar", 
                months:"28 October — 1 November", 
            ...
            { Rectangle: 'assets/Rectangle 3.png', 
                rate: 'assets/rating.png', 
                favorite: 'assets/favorite.png', 
                SpecialofferDescription: 'Wilderness Club at Big <br> Ceddar', 
                months:"28 October — 1 November", 
...
const reviews = [
        { Ellipse: 'assets/Ellipse 1.png',
            reviewDescription: 'I quickly found the right tour for me, but I had a few questions about the hotel, I wrote to tech support and they answered all my questions within an hour. The vacation itself was perfect. Thank you very much. I will come back again and again.', 
            work: "Publisher", 
            scholars: 'Jannike Borg,'
        },
    ...
    const recents = [
            { Rectangle2: 'assets/Rectangle 4.png',
                recentDate: 'May 23, 2022 ', 
                minutes: 'assets/time.png', 
                titlerecent:"My trip to Athens", 
                recentDescription: 'It would seem that in a city where Theseus, Plato and Epicurus once walked, the very idea of the subway is alien to the city, but already...' 
            },
            { Rectangle2: 'assets/Rectangle 5.png', 
                recentDate: "May 22, 2022", 
                minutes: 'assets/time (1).png', 
                titlerecent:"Vilnius resorts", 
                recentDescription: "I haven't seen any resorts in Vilnius, but there are wonderful people and pubs" 
            },
            { Rectangle2: 'assets/Rectangle 6.png', 
                recentDate: 'May 20, 2022', minutes: 'assets/time (2).png', 
                titlerecent:"Tips for flying on a plane", 
                recentDescription: "If you have a fear of flying, here's a helpful tip: bring your co-pilot so you can take a nap while he steers the plane for you" 
            },
        ];
